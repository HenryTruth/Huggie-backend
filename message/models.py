...
class Message(models.Model):
    ...
    receiver = models.ForeignKey(Profile, related_name="message_reciever", on_delete=models.CASCADE)
    message = models.TextField(blank=True, null=True)
    is_read = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"message between {self.sender.user.username} and {self.receiver.user.username}"
